...
export const getUserLeagueMemberList = (param) => get({url: `${config.basketball_service}/basketball/charge/member?${unpack(param)}`})
    .then(function (response) {
        return response.data;
    }).catch(function (error) {
        console.log(error)
    });
export const getLeagueMemberRule = (param) => get({url: `${config.basketball_service}/basketball/charge/member/league?${unpack(param)}`})
    .then(function (response) {
        return response.data;
    }).catch(function (error) {
        console.log(error)
...
export const addLeagueMemberRule = (param) => post({
    url: `${config.basketball_service}/basketball/charge/member/league`,
    data: param
})
    .then(function (response) {
        return response.data;
