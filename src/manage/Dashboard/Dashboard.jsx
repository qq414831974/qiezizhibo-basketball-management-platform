                    ...
                    <Col className="gutter-row" md={8}>
                        <div className="gutter-box">
                            <Card title="新增功能" bordered={false}
                                ...
                                <div className="w-full">2021-11-08：联赛组委会功能更新</div>
                                <div className="w-full">2021-11-04：创建系列赛填写轮次，场地，组别等信息，在创建系列赛中的联赛时会提供默认值</div>
                                <div className="w-full">2021-11-02：联赛会员更新</div>
                                <div className="w-full">2021-09-29：新增待办事项</div>
                                <div className="w-full">2021-09-22：热度PK更新</div>
                                <div className="w-full">2021-08-10：联赛会员更新</div>
                                <div className="w-full">2021-07-20：新增球员榜</div>
                                <div className="w-full">2021-07-13：新增篮球统计</div>
                                <div className="w-full">2021-07-01：新增报名系统</div>
                                <div className="w-full">2021-05-21：新增反馈投诉查看</div>
                                <div className="w-full">2021-05-21：新增联赛会员、等级系统</div>
                                <div className="w-full">2021-03-27：系统上线</div>
                            </Card>
                        </div>
                    </Col>
