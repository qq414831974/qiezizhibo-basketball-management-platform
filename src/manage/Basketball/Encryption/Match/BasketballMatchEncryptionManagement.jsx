...
class BasketballMatchEncryptionManagement extends React.Component {
    state = {
        data: {},
    }
                        ...
                        <div className="gutter-box">
                            <Card className={this.props.responsive.data.isMobile ? "no-padding" : ""} bordered={false}>
                                <Tabs activeKey={this.state.currentTab} onChange={(value) => {
                                    ...
                                    this.props.history.replace(`/basketball/match/encryption?matchId=${currentMatch}&tab=${value}`)
                                }}>
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballMatchEncryptionManagement);