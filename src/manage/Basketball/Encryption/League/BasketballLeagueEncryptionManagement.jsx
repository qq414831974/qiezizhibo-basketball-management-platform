...
class BasketballLeagueEncryptionManagement extends React.Component {
    state = {
        data: {},
        leagueData: {},
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballLeagueEncryptionManagement);