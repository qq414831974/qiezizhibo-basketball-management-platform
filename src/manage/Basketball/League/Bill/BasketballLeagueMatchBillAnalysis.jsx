...
class BasketballLeagueMatchBillAnalysis extends React.Component {
    state = {
        data: {},
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballLeagueMatchBillAnalysis);