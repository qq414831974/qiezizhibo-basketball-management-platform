...
import BasketballLeagueMatchAddDialog from "./BasketballLeagueMatchAddDialog"
import BasketballLeagueMatchModifyDialog from "./BasketballLeagueMatchModifyDialog"
...
class BasketballLeagueMatchTable extends React.Component {
    state = {
        data: [],
        ...
        if (record && record.isParent) {
            return [
                <Button key="view" type="primary" className="pull-left">
                    <Link to={
                        `/basketball/basketballLeagueSeries/${this.state.record.id}`
                    }>浏览联赛</Link>
                </Button>,
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballLeagueMatchTable);