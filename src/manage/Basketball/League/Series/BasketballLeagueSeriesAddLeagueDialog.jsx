...
class BasketballLeagueSeriesAddLeagueDialog extends React.Component {
    state = {data: []}
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballLeagueSeriesAddLeagueDialog);