...
import BasketballLeagueMatchModifyDialog from "./BasketballLeagueSeriesModifyDialog";
import BasketballLeagueMatchAddDialog from "./BasketballLeagueSeriesAddDialog";
import {Link} from 'react-router-dom';
import BasketballLeagueSeriesAddLeagueDialog from "./BasketballLeagueSeriesAddLeagueDialog";
import {Base64} from 'js-base64';

class BasketballLeagueMatchSeriesManagement extends React.Component {
    state = {
        data: [],
        record: {},
        leagueData: {},
    ...
    getAddDialogForm = () => {
        ...
        this.addDialogForm = Form.create()(BasketballLeagueMatchAddDialog);
        return this.addDialogForm;
    }
    getModifyDialogForm = () => {
        ...
        this.modifyDialogForm = Form.create()(BasketballLeagueMatchModifyDialog);
        return this.modifyDialogForm;
    }
    ...
    render() {
        ...
        const AddLeagueDialog = Form.create()(BasketballLeagueSeriesAddLeagueDialog);
                ...
                <Modal
                    ...
                    footer={[
                        <Button key="battle" type="primary" className="pull-left">
                            <Link to={
                                `/basketball/basketballLeagueMatch/${this.state.record.id}`
                            }>战报积分榜设置</Link>
                        </Button>,
                        <Button key="detail" type="primary" className="pull-left">
                            <Link to={
                                `/basketball/league/detail/${this.state.record.id}`
                            }>详细设置</Link>
                        </Button>,
                        <Button key="view" type="primary" className="pull-left">
                            <Link to={
                                `/basketball/basketballMatch?leagueId=${this.state.record.id}`
                            }>浏览比赛</Link>
                        </Button>,
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballLeagueMatchSeriesManagement);