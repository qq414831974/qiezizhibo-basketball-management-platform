...
class BasketballLeagueMatchAddPlayerDialog extends React.Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballLeagueMatchAddPlayerDialog);