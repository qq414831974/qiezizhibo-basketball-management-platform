...
class BasketballLeagueDetailSetting extends React.Component {
    state = {
        data: {},
        leagueData: {},
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballLeagueDetailSetting);