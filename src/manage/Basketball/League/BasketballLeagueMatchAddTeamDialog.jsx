...
class BasketballLeagueMatchAddTeamDialog extends React.Component {
    state = {data: []}
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballLeagueMatchAddTeamDialog);