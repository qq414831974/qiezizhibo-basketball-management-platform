...
class BasketballLeagueMatchModifyPlayerDialog extends React.Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballLeagueMatchModifyPlayerDialog);