...
class BasketballLeagueMatchModifyTeamDialog extends React.Component {
    state = {data: []}
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballLeagueMatchModifyTeamDialog);