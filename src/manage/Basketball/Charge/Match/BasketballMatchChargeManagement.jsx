...
class BasketballMatchChargeManagement extends React.Component {
    state = {
        data: {},
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballMatchChargeManagement);