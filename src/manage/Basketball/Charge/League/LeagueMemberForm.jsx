...
class LeagueMemberForm extends React.Component {
    ...
    getPosterSelector = () => {
        ...
        return <Select style={{width: 120}} placeholder="默认二维码">
            <Option key={`default`}
                    value="https://qiezizhibo-1300664818.cos.ap-shanghai.myqcloud.com/images/contact_qrcode/juesha.jpeg"
                    onClick={() => {
                        form.setFieldsValue({
                            contactQrcode: "https://qiezizhibo-1300664818.cos.ap-shanghai.myqcloud.com/images/contact_qrcode/juesha.jpeg"
                        })
                    }}>
                默认二维码
            </Option>
