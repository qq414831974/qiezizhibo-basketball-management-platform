...
import BasketballLeagueMatchBillAnalysis from "../../League/Bill/BasketballLeagueMatchBillAnalysis";
...
class BasketballLeagueChargeManagement extends React.Component {
    state = {
        data: {},
        memberData: {},
        leagueData: {},
                        ...
                        <div className="gutter-box">
                            <Card className={this.props.responsive.data.isMobile ? "no-padding" : ""}
                                ...
                                <Tabs activeKey={this.state.currentTab} onChange={(value) => {
                                    ...
                                    this.props.history.replace(`/basketball/league/charge?leagueId=${currentLeague}&tab=${value}`)
                                }}>
                                    ...
                                    <TabPane tab="收益查看" key="2">
                                        <BasketballLeagueMatchBillAnalysis leagueId={currentLeague}/>
                                    </TabPane>
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballLeagueChargeManagement);