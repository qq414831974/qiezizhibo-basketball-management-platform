...
class BasketBallLeagueRegistrationManagement extends React.Component {
    state = {
        data: {},
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketBallLeagueRegistrationManagement);