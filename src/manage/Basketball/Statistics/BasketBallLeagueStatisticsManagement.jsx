...
class BasketBallLeagueStatisticsManagement extends React.Component {
    state = {
        data: {},
        leagueData: {},
    }
    ...
    onStatisticsDetailClick = () => {
        ...
        history.push(`/basketball/league/statistics/team?leagueId=${currentLeague}`);
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketBallLeagueStatisticsManagement);