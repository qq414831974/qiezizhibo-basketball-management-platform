            ...
            <Modal
                ...
                footer={[
                    <Button key="more" type="primary" className="pull-left">
                        <Link to={
                            "/basketball/basketballMatch/" + this.state.record.id
                        }>详细设置</Link>
                    </Button>,
                    <Button key="comment" type="primary" className="pull-left">
                        <Link to={
                            `/basketball/comment/${this.state.record.id}`
                        }>评论</Link>
                    </Button>,
                    <Button key="charge" type="primary" className="pull-left"><Link to={
                        `/basketball/match/charge?matchId=${this.state.record.id}`
                    }>收费</Link>
                    </Button>,
                    <Button key="comment" type="primary" className="pull-left">
                        <Link to={
                            `/basketball/match/heat?matchId=${this.state.record.id}`
                        }>热度</Link>
                    </Button>,
                    <Button key="bet" type="primary" className="pull-left"><Link to={
                        `/basketball/match/bet?matchId=${this.state.record.id}`
                    }>竞猜</Link>
                    </Button>,
                    <Button key="bet" type="primary" className="pull-left"><Link to={
                        `/basketball/match/clip?matchId=${this.state.record.id}`
                    }>剪辑</Link>
                    </Button>,
                    <Button key="bet" type="primary" className="pull-left"><Link to={
                        `/basketball/match/encryption?matchId=${this.state.record.id}`
                    }>加密</Link>
                    </Button>,
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballMatchTable);