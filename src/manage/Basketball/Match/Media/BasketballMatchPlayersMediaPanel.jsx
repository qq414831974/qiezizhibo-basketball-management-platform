...
import BasketballPlayerModifyMediaDialog from "../../Player/BasketballPlayerModifyMediaDialog";
...
class BasketballMatchPlayersMediaPanel extends React.Component {
    state = {
        playerInfo: {},
        pageLoaded: false,
        againstPlayers: {}
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballMatchPlayersMediaPanel);