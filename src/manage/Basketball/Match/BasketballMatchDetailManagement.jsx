...
import MatchSimpleForm from "./BasketballMatchModifyDialog";
import {delMatchByIds, getMatchById, updateMatchById} from "../../../axios";
import BasketballMatchPlayersMediaPanel from "./Media/BasketballMatchPlayersMediaPanel";
...
class BasketballMatchDetailManagement extends React.Component {
    ...
    render() {
        if (!(this.props.match.params && this.props.match.params.id)) {
            return <Redirect push to="/basketball/basketballMatch"/>;
        }
        ...
        return this.state.pageLoaded ? (
            <div className="gutter-example">
                <BreadcrumbCustom first={<Link to={'/basketball/basketballMatch'}>球赛管理</Link>} second="详细设置"/>
                <Row gutter={16}>
                    <Col className="gutter-row">
                        <div className="gutter-box">
                            <Card bordered={false}>
                                <div className="inline-block">
                                    <Link to={'/basketball/basketballMatch'}>
                                ...
                                <Tabs activeKey={this.state.currentTab} onChange={(value) => {
                                    ...
                                    this.props.history.replace(`/basketball/basketballMatch/${this.props.match.params.id}?tab=${value}`)
                                }}>
