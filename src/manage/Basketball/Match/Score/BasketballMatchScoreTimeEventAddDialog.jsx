...
class BasketballMatchScoreTimeEventAddDialog extends React.Component {
    state = {
        current: 0,
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballMatchScoreTimeEventAddDialog);