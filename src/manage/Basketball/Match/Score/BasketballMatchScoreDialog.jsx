...
import BasketballMatchScoreAddDialog from './BasketballMatchScoreAddDialog';
import BasketballMatchScoreModifyDialog from './BasketballMatchScoreModifyDialog';
import BasketballMatchScoreTimeEventAddDialog from './BasketballMatchScoreTimeEventAddDialog';
import BasketballMatchScoreTimeEventModifyDialog from './BasketballMatchScoreTimeEventModifyDialog';
...
class BasketballMatchScoreDialog extends React.Component {
    state = {
        data: {},
        playerInfo: {},
        timeline: [],
    ...
    render() {
        ...
        return visible ?
            <div><Row gutter={2}>
                ...
                >
                    <BasketballMatchScoreAddDialog visible={this.state.drawVisible}
                ...
                <Drawer
                    ...
                    height={this.state.drawHeight}
                >
                    <BasketballMatchScoreModifyDialog visible={this.state.drawModifyVisible}
                                                    onHeightChange={onDrawHeightChange}
                                                    matchId={this.props.matchId}
                                                    data={this.state.data}
                ...
                >
                    <BasketballMatchScoreTimeEventAddDialog visible={this.state.drawEventAddVisible}
                                                          matchId={this.props.matchId}
                                                          data={this.state.data}
                                                          onClose={onEventAddDrawClose}
                                                          onSuccess={refreshTimeLine}
                ...
                <Drawer
                    ...
                    height={this.state.drawEventHeight}
                >
                    <BasketballMatchScoreTimeEventModifyDialog visible={this.state.drawEventModifyVisible}
                                                             matchId={this.props.matchId}
                                                             data={this.state.data}
                                                             record={this.state.record}
                                                             onClose={onEventModifyDrawClose}
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballMatchScoreDialog);