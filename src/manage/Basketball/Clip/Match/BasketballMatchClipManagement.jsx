...
import BasketballMatchPlayersMediaPanel from "../../Match/Media/BasketballMatchPlayersMediaPanel";

const TabPane = Tabs.TabPane;

class BasketballMatchClipManagement extends React.Component {
    state = {
        data: {},
    }
                        ...
                        <div className="gutter-box">
                            <Card className={this.props.responsive.data.isMobile ? "no-padding" : ""} bordered={false}>
                                <Tabs activeKey={this.state.currentTab} onChange={(value) => {
                                    ...
                                    this.props.history.replace(`/basketball/match/clip?matchId=${currentMatch}&tab=${value}`)
                                }}>
                                    ...
                                    <TabPane tab="视频列表" key="3">
                                        {this.state.matchLoading ? null : <BasketballMatchPlayersMediaPanel
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballMatchClipManagement);