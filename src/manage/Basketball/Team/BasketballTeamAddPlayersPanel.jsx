...
import ModifyPlayerInTeamDialog from "./BasketballTeamModifyPlayersDialog";
import AddPlayerToTeamDialog from "./BasketballTeamAddPlayersDialog";
...
class BasketballTeamAddPlayersPanel extends React.Component {
    state = {
        pageLoaded: false,
        data: {},
        teamdata: {},
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballTeamAddPlayersPanel);