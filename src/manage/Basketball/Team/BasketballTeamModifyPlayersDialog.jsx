...
class BasketballTeamModifyPlayersDialog extends React.Component {
    state = {}
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballTeamModifyPlayersDialog);