...
import BasketballTeamAddDialog from "./BasketballTeamAddDialog"
import BasketballTeamModifyDialog from "./BasketballTeamModifyDialog"
...
class BasketballTeamTable extends React.Component {
    state = {
        data: [],
    ...
    render() {
        ...
        const AddDialog = Form.create()(BasketballTeamAddDialog);
        const ModifyDialog = Form.create()(BasketballTeamModifyDialog);
            ...
            <Modal
                ...
                footer={[
                    <Button key="more" type="primary" className="pull-left">
                        <Link to={
                            "/basketball/basketballTeam/" + this.state.record.id
                        }>详细设置</Link>
                    </Button>,
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballTeamTable);
