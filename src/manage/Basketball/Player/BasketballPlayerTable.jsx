...
import BasketballPlayerAddDialog from "./BasketballPlayerAddDialog"
import BasketballPlayerModifyDialog from "./BasketballPlayerModifiyDialog"
...
class BasketballPlayerTable extends React.Component {
    state = {
        data: [],
    ...
    render() {
        ...
        const AddDialog = Form.create()(BasketballPlayerAddDialog);
        const ModifyDialog = Form.create()(BasketballPlayerModifyDialog);
            ...
            <Modal
                ...
                footer={[
                    <Button key="detail" type="primary" className="pull-left">
                        <Link to={
                            `/basketball/basketballPlayer/${this.state.record.id}`
                        }>详细设置</Link>
                    </Button>,
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballPlayerTable);