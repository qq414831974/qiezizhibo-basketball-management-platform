...
class BasketballPlayerModifyMediaDialog extends React.Component {
    state = {
        position: undefined,
        data: [],
        match: {}
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballPlayerModifyMediaDialog);