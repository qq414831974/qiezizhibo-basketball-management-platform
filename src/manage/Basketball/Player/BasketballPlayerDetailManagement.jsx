...
import BasketballPlayerModifyMediaDialog from "./BasketballPlayerModifyMediaDialog";
...
class BasketballPlayerDetailManagement extends React.Component {
    state = {}
    ...
    render() {
        ...
        if (!(this.props.match.params && this.props.match.params.id)) {
            return <Redirect push to="/basketball/basketballPlayer"/>;
        }
        ...
        return (
            <div>
                <BreadcrumbCustom first={<Link to={'/basketball/basketballPlayer'}>球员管理</Link>} second="详细设置"/>
...
export default connect(mapStateToProps, mapDispatchToProps)(BasketballPlayerDetailManagement);