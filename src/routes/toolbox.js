...
import UserLeagueMemberTable from '../manage/Basketball/Charge/League/UserLeagueMemberTable';
        ...
        return (
            <Switch>
                ...
                <Route exact path="/toolbox/leagueMember"
                       component={this.requireAuth("/basketball/league/charge", UserLeagueMemberTable)}/>
